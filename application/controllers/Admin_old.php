...
class Admin extends CI_Controller
{
    ...
    public function pre_collection_confirm()
    {
        ...
        if ($pre_date == $this
            ->input
            ->post('date', true) && $_SESSION['user_id'] == $employee_id)
        {
            ...
            $this
                ->session
                ->set_flashdata('msg', '<font color=red>Please contact with your admin!</font>');
            redirect(base_url('admin/pre_collection'));
        }
        $this
            ->session
            ->set_flashdata('msg', '<font color=red>Please Do not try again!</font>');
        redirect(base_url('admin/pre_collection'));
    }
