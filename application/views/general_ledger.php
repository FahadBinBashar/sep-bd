...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i>General Ledger Report             
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <h3 class="box-title titlefix">General Ledger Report</h3>
                    ...
                    <div class="box-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="col-md-12">
                                 <select name="ledger_id" required class="form-control" style="width:250px; float:left;">
                                    <option value="" selected disabled>Select</option>
                                    <?php
                                        $query = $this->db->query("select * from ledger_list where sts = '1' and id != '1' ");
                        ...
                        <h3>
                            ...
                            <?php
                                if (isset($_POST['fdate'])) {
                                    ...
                                    echo " of ";
                                    echo " (".get_name_by_auto_id('ledger_list', $ledger_id, 'ledger_name').")";
                                    echo '<br>';                                                               

                                    $total_debit=0;
                                     
                                    $queryta = $this->db->query("select * from acc_transaction where VDate between '$fdate' and '$tdate' and IsAppove = '1' and ledger_id = '$ledger_id' ");
                                    ...
                                    $total_credit=0;
                                    $querytp = $this->db->query("select * from acc_transaction where VDate between '$fdate' and '$tdate' and IsAppove = '1' and ledger_id = '$ledger_id' ");
                                    ...
                                    $total_Balance = $total_debit-$total_credit;                                    
                                     ...
                                     $oResult=$this->db->query("SELECT SUM(Debit) Debit, SUM(Credit) Credit, IsAppove, ledger_id FROM acc_transaction WHERE VDate < '$fdate' AND ledger_id LIKE '$ledger_id' AND IsAppove =1 GROUP BY IsAppove, ledger_id");
                                      $PreBalance=0;
                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <td align="left"><?php echo number_format((!empty($PreBalance)?$PreBalance:0),2,'.',','); ?></td>
                                    ...
                                    $TotalDebit=0;
                                        ...
                                        $tdate = $_POST['tdate'];
                                        $ledger_id = $_POST['ledger_id'];
                                           $query = $this->db->query("select * from acc_transaction where VDate between '$fdate' and '$tdate' and IsAppove = '1' and ledger_id = '$ledger_id' ORDER BY VDate ASC ");
                                    foreach ($query->result() as $key => $value) {
