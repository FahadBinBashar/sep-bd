...
<div class="content-wrapper">  
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Add New Ledger 
            <?php
                if (isset($_POST['add'])) {      
                    ...
                    <form action="#" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="cart">
                        <div class="box-body">
                            <div class="tshadow mb25 bozero">    
                                <h4 class="pagetitleh2">Add New Ledger</h4>
                                ...
                                <div class="around10">
                                    <div class="row">
                                     ...
                                     <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Select For Balance Sheet</label>
                                                
                                               <select name="bs_cat" required class="form-control" required>
                                                    <option value="" selected disabled>Select</option>
                                                    <?php
                                                        $query = $this->db->query("select * from bs_ledger_list where sts = '1' ");
                                                        foreach ($query->result() as $key => $value) {
                                                            echo "<option value='$value->id'>$value->ledger_name.$value->ledger_cat</option>";
                                                        }
                                                    ?>
                                                </select>
                                            </div>
