                           ...
                           <table class="table table-striped table-bordered table-hover example">
                              <thead>
                                 <tr>
                                    ...
                                    <th>View</th>
                                    <?
    								if ($_SESSION['status'] == 'a' && $_SESSION['user_id']==0) {
									?>
                                    <th>Action</th>
                                    <?
    }
...
?>
        ...
        if ($_SESSION['status'] == 'a' && $_SESSION['user_id']==0 && $total_qnt == $cnnt && $loan_id != null) {
...
?>
                                       ...
                                       <?
        } elseif ($_SESSION['status'] == 'a' && $_SESSION['user_id']==0) {
?>
...
?>
                                       <?
        if ($_SESSION['status'] == 'a' && $_SESSION['user_id']==0 && $sb=='0' && $loan_id=='') {
?>
