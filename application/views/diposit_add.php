...
<div class="content-wrapper">  
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Open New SSP Account 
            <?php
                if (isset($_POST['add'])) {      
                    ...
                    if ( $this->db->affected_rows() ) {
                        ...
                        redirect(base_url('admin/diposit_list'));
                    } else {
                        $this->session->set_flashdata('msg', '<font color=red>NOT Success!</font>');
                        redirect(base_url('admin/diposit_add'));
                    }                  
                    ...
                    <form action="#" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="cart">
                        <div class="box-body">
                            <div class="tshadow mb25 bozero">    
                                <h4 class="pagetitleh2">Open New Diposit Account</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="start_date" type="text" value="<?php echo date("Y-m-d"); ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob2" name="end_date" type="text" value="<?php echo date("Y-m-d"); ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="monthly_amount" type="text" class="form-control" required>
                                            </div>
                                        </div>
                                                ...
                                                <select class="select2" name="employee_id" required style="width:100%;">
                                                    ...
                                                    <?php
                                                        if ($_SESSION['status']=='a') { 
                                                            ...
                                                            echo "<option value='".$_SESSION['user_id']."' selected>".$_SESSION['name']."</option>";
                                                        }
                                                    ?>
                                                </select>
                                                <span class="text-danger"></span>
