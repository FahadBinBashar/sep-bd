...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> Credit Voucher   
            ...
            <?php
                ...
                $query =$this->db->insert('acc_transaction',$Dr); 
                 ...
                 if ( $this->db->affected_rows() ) {
                        ...
                        redirect(base_url('admin/cr_voucher'));
                    } else {
            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add New Credit Voucher</h3>
                    </div><!-- /.box-header -->
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Credit Voucher Summery </h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    <?php 
                                        $query = $this->db->select('*')->from('acc_transaction ')->where('Vtype =','Cr')->where('ledger_id !=', 1)->where('IsAppove', 1)->order_by('id', 'desc')->get();
                                        foreach ($query->result() as $key => $value) {
                                    ?>
									<tr>                                               
										<td><?= ++$key ?></td>
