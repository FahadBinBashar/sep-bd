...
<div class="content-wrapper">  
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Edit Account 
            <?php
                if (isset($_POST['add'])) {                    
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php
                        $query = $this->db->select('*')->from('account')->where('id', $_GET['id'])->get();
                    ...
                    <form id="form1" action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="tshadow mb25 bozero">    
                                <h4 class="pagetitleh2">Edit Account</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Date</label>
                                                <input id="dob" name="pdate" type="text" value="<?= $value->pdate ?>" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="ac_no" value="<?= $value->ac_no ?>" type="text" class="form-control" >
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Father</label>
                                                <input name="father" value="<?= $value->father ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Mother</label>
                                                <input name="mother" value="<?= $value->mother ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="zone_id" class="form-control">
                                                    <option value="<?= $value->zone_id ?>" selected><?= get_name_by_auto_id('zone', $value->zone_id, 'name') ?></option>
                                                    <?php
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="filestyle form-control" type='file' name='pic' id="file">
                                                <input type="hidden" name="pic_name" value="<?= $value->pic ?>">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>SL</label>
                                                <input name="sl" value="<?= $value->sl ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="business_address" value="<?= $value->business_address ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input name="nominee_name_a" value="<?= $value->nominee_name_a ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Father/Mother</label>
                                                <input name="nominee_co_a" value="<?= $value->nominee_co_a ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Age</label>
                                                <input name="nominee_age_a" value="<?= $value->nominee_age_a ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Relation</label>
                                                <input name="nominee_relation_a" value="<?= $value->nominee_relation_a ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Value (%)</label>
                                                <input name="nominee_value_a" value="<?= $value->nominee_value_a ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input name="nominee_name_b" value="<?= $value->nominee_name_b ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Father/Mother</label>
                                                <input name="nominee_co_b" value="<?= $value->nominee_co_b ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Age</label>
                                                <input name="nominee_age_b" value="<?= $value->nominee_age_b ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Relation</label>
                                                <input name="nominee_relation_b" value="<?= $value->nominee_relation_b ?>" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Value (%)</label>
                                                <input name="nominee_value_b" value="<?= $value->nominee_value_b ?>" type="text" class="form-control">
                                            </div>
                                        </div>
