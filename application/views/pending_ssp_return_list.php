...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> Special Saving Program (ssp) Return Statement 
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <?php 
                            $cnt=0; 
                            $query = $this->db->query("select * from diposit_collection where sts = '2' ");
                            foreach($query->result() as $value) {
                                $cnt = $cnt+1;
                            }
                        ?>
                        <h3 class="box-title titlefix">SSP return pending list (<?= $cnt ?>)</h3>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
									...
									<tr>                                               
                                        ...
                                        <td style="border: 1px solid #ddd;">
                                            <a href="<?= base_url() ?>admin/ssp_return_confirm/<?= $result->id ?>/<?= $result->Vno ?>" onclick="return confirm('Approve Confirm?');">
                                                Approve
                                            </a>                                               
                                        </td>
                                        <td style="border: 1px solid #ddd;">
                                            <a href="<?= base_url() ?>admin/ssp_return_reject/<?= $result->id ?>" onclick="return confirm('Reject Confirm?');">
                                                Reject
                                            </a>                                              
                                        </td>
