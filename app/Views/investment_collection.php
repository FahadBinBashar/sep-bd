            ...
            <?php
                if (isset($_POST['f_save'])) {
                    ...
                    if ( $this->db->affected_rows() ) {
                        ...
                        redirect(base_url('admin/investment_collection'));
                    } else {
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Investment Deposit Summery </h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    <?php 
                                        $query = $this->db->select('*')->from('investment_collection ')->where('amount_receive >', 0)->where('sts', 1)->order_by('id', 'desc')->get();
                                        foreach ($query->result() as $key => $value) {
                                    ?>
									<tr>                                               
										<td><?= ++$key ?></td>
