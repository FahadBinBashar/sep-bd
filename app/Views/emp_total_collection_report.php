...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i>Emp Total Collection Report             
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <h3 class="box-title titlefix">Emp Total Collection Report</h3>
                        ...
                        <h3>
                            ...
                            <?php
                                if (isset($_POST['fdate'])) {
                                    ...
                                    $total_asol=0;
                                    $queryta = $this->db->query("select * from loan_collection where pdate between '$fdate' and '$tdate' and sts = '1' and employee_id = '$emp_id' ");
                                    foreach ($queryta->result() as $valueta) {
                                        $total_asol = $total_asol+$valueta->asol;
                                    }

                                    $total_profit=0;
                                    $querytp = $this->db->query("select * from loan_collection where pdate between '$fdate' and '$tdate' and sts = '1' and employee_id = '$emp_id' ");
                                    ...
                                    $total_saving=0;                                                   
                                    $querys = $this->db->query("select * from saving_collection where pdate between '$fdate' and '$tdate' and sts = '1' and employee_id = '$emp_id' ");
                                    ...
                                    <tr>                                               
                                        ...
                                        <td style="border: 1px solid #ddd;">
                                            <?php
                                                //asol
                                                $total_asol2=0;
                                                $queryta2 = $this->db->select('*')->from('loan_collection')->where('pdate', $cdate)->where('employee_id', $emp_id)->where('sts', 1)->get();
                                        ...
                                        <td style="border: 1px solid #ddd;">
                                            <?php
                                                //profit
                                                $total_profit2=0;
                                                $querytp2 = $this->db->select('*')->from('loan_collection')->where('pdate', $cdate)->where('employee_id', $emp_id)->where('sts', 1)->get();
                                        ...
                                        <td style="border: 1px solid #ddd;">
                                            <?php
                                                //total loan
                                                $total_loan2=0;
                                                $querytl2 = $this->db->select('*')->from('loan_collection')->where('pdate', $cdate)->where('employee_id', $emp_id)->where('sts', 1)->get();
                                        ...
                                        <td style="border: 1px solid #ddd;">
                                            <?php
                                                //total saving
                                                $total_saving2=0;                                                    
                                                $querys2 = $this->db->select('*')->from('saving_collection')->where('pdate', $cdate)->where('employee_id', $emp_id)->where('sts', 1)->get();
