...
<div class="content-wrapper">  
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Set previous date 
            <?php
                if (isset($_POST['add'])) {      
                    ...
                    $this->db->insert('admin_selected_date', $data);
                    ...
                    if ( $this->db->affected_rows() ) {
                        ...
                        redirect(base_url('admin/date_add'));
                    }                  
                    ...
                    <form action="#" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="cart">
                        <div class="box-body">
                            <div class="tshadow mb25 bozero">    
                                <h4 class="pagetitleh2">Set previous date</h4>
