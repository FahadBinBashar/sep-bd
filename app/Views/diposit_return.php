...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i>  এস এস পি ফেরত   
            ...
            <?php
                if (isset($_POST['f_save'])) {
                    ...
                    $sspreturnCash = array(
                          ...
                          'ledger_id'      =>  1,
                          'Narration'      =>  "এসএসপি ফেরত হিসাব--".$_SESSION['name'],
                          'Debit'          =>  0,
                        ...
                        $query =$this->db->insert('acc_transaction',$sspreturnCash); 
                        $sspreturn = array(
                          'VNo'            =>  $time.$this->input->post('ac_id', true),
                          'Vtype'          =>  'AutoSRDr',
                          'VDate'          =>  $this->input->post('pdate', true),
                        ...
                        $query =$this->db->insert('acc_transaction',$sspreturn);
                    ...
                    if ( $this->db->affected_rows() ) {
                        ...
                        redirect(base_url('admin/diposit_return'));
                    } else {
                    ...
                    <form id="form1" action="#"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Date</label>
                                <input  name="pdate" type="date" value="<?php echo date("Y-m-d"); ?>" class="form-control" required <?php echo ($setting['ssprd'] == '0') ? "readonly" : "";?>>
                            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> এস এস পি ফেরত Summery </h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    <?php 
                                        $query = $this->db->select('*')->from('diposit_collection ')->where('amount_return >', 0)->where('employee_id', $_SESSION['user_id'])->order_by('id', 'desc')->get();
                                        foreach ($query->result() as $key => $value) {
                                    ?>
									<tr>                                               
										<td><?= ++$key ?></td>
