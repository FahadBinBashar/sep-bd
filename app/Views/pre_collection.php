<?php
   ...
   {
       error_reporting(0);
       $querycc = $this->db->select('*')->from('admin_selected_date')->where('employee_id', $_SESSION['user_id'])->where('sts', 1)->get();
   ...
   <body class="hold-transition skin-blue fixed sidebar-mini">
      ...
      <div class="content-wrapper">
         <section class="content-header">
            <h1>
               <i class="fa fa-object-group"></i> Previous Collection (<?=$pre_date;?>)            
               <?php echo $this
                  ->session
                  ->flashdata('msg'); ?>
            </h1>
                  ...
                  <div class="box box-primary">
                     ...
                     <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                           <form action="<?=base_url() ?>admin/pre_collection_confirm" id="form" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="cart">					
                             
                             
                             
                             <input id="dob" name="date" type="hidden" value="<?php echo $pre_date; ?>" class="form-control">
                                          ...
                                          <?php
                                             ...
                                             
                                             {
                                                 ...
                                                 $queryc = $this
                                                     ...
                                                     ->select('*')
                                                     ->from('loan_collection')
                                                     ->where('loan_id', $loan_id)->where('pdate', $pre_date)->where('sts', 1)
                                                     ->get();
                                       ...
                                       <td style="border: 1px solid #ddd;">       
                                          <?php
                                             ...
                                             $querys = $this
                                                 ...
                                                 ->where('ac_no', $result->id)
                                                 ->where('pdate', $pre_date)->where('sts', 1)
                                                 ->get();
