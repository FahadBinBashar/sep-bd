...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> Employee List for Transfer Member to Another Employee
            <?php
                if (isset($_GET['did'])) {
                    $data = array('sts' => 0);
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
									...
									<tr>                                               
                                        ...
                                        <td style="border: 1px solid #ddd;">
                                            <a href="<?= base_url() ?>admin/transfermember_list_emp?employee_id=<?= $result->id ?>">AC List
                                        </td>
