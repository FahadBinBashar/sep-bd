                                ...
                                <tbody>
                                   ...
                                   <?php 
									...
									<tr>                                               
										...
										<td><?= $aid=$result->id; ?></td>
										<td><?= $result->name ?></td>
										<td><?  $loan_details=$this->admin_model->custom_loan_details($aid,$qqsdate);echo $loan_details['id'];?></td>
                                        ...
                                        <!--</td>-->
                                        <td >
                                            <?  $saving_details=$this->admin_model->custom_saving_details($aid,$qqsdate);
                                                 $totalsr=$saving_details['sreceive'];
