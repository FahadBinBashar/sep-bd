                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td align=""><strong>Debit</strong></td>
                                        <td align=""><strong>Credit</strong></td>
                                        <td align="" ><strong>Balance</strong></td>
                                    </tr>
                                </thead>
                            ...
                            <td align="left"><?php echo number_format((!empty($PreBalance)?$PreBalance:0),2,'.',','); ?></td>
                                    ...
                                    $TotalDebit=0;
                                        ...
                                        $fdate = $_POST['fdate'];
                                        $tdate = $_POST['tdate'];
                                           $query = $this->db->query("select ledger_id, VDate, SUM(Debit) AS Credit, SUM(Credit) AS Debit from acc_transaction where VDate between '$fdate' and '$tdate' and IsAppove = '1' and ledger_id != '1' GROUP BY ledger_id ASC  ");
                                    ...
                                    <tr>                                               
                                        ...
                                        <td style="border: 1px solid #ddd;"><?= get_name_by_auto_id('ledger_list', $value->ledger_id, 'ledger_name') ?></td>
